...
class TestHg203(TestCase):
    ...
    def test_create(self):
        ...
        self.assertTrue('/mpr/lm_hg203/barrows_and_gilts' in db.connection)
    ...
    def tearDownClass(cls):
        db.connection.remove_node('/mpr/lm_hg203/barrows_and_gilts')
    ...
    def test_query(self):
        ...
        self.assertEqual(negotiated.report_date, date(2018, 1, 1))
    ...
    def test_array(self):
        ...
        self.assertTrue(all(records.report_date == date(2018, 1, 1)))
