...
def create() -> Group:
    group = db.connection.create_group(
        where=db.mpr,
        name=PurchaseReport.LM_HG203.name,
        title=PurchaseReport.LM_HG203.value)
...
barrows_gilts = PurchaseEntity(PurchaseReport.LM_HG203, PurchaseSection.BARROWS_AND_GILTS)
